...
export const STATION_TEXT_STYLE: SymbolLayerSpecification = {
  ...
  layout: {
    ...
    //   "step",0
    //   ["zoom"],
    //   false, // default value (zoom < ZOOM_THRESHOLDS.maximum)
    //   ZOOM_THRESHOLDS.maximum,
    //   true, // when zoom >= ZOOM_THRESHOLDS.maximum
    // ],
