...
import type { MetarData, MetarWithStation, SfcObsPopupBundle, StationPlotData } from "@wx/shared/lib/types.js";
import { metars, stations, tafs } from "@wx/shared/db/tables/avwx.drizzle.js";
